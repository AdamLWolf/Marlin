...
#define MSG_PREHEAT_2                       _UxGT("Zahriať PETG")
...
#define MSG_UBL_BUILD_PETG_MESH              _UxGT("Sieť bodov PETG")
...
#define MSG_UBL_VALIDATE_PETG_MESH           _UxGT("Kontrola siete PETG")
