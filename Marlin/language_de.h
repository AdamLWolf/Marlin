...
#define MSG_PREHEAT_2                       _UxGT("Vorwärmen PETG")
#define MSG_PREHEAT_2_N                     _UxGT("Vorwärmen PETG ")
#define MSG_PREHEAT_2_ALL                   _UxGT("Vorw. PETG Alle")
#define MSG_PREHEAT_2_END                   _UxGT("Vorw. PETG Extr.")
#define MSG_PREHEAT_2_BEDONLY               _UxGT("Vorw. PETG Bett")
#define MSG_PREHEAT_2_SETTINGS              _UxGT("Vorw. PETG Einst.")
...
#define MSG_FREE_XY                         _UxGT("PETGtand XY")
...
#define MSG_UBL_BUILD_PETG_MESH            _UxGT("Netz erstellen PETG")
...
#define MSG_UBL_VALIDATE_PETG_MESH         _UxGT("Netz validieren PETG")
