...
#define MSG_PREHEAT_2                       _UxGT("Подгряване PETG")
#define MSG_PREHEAT_2_N                     _UxGT("Подгряване PETG")
#define MSG_PREHEAT_2_ALL                   _UxGT("Подгр. PETG Всички")
#define MSG_PREHEAT_2_BEDONLY               _UxGT("Подгр. PETG Легло")
#define MSG_PREHEAT_2_SETTINGS              _UxGT("Настройки PETG")
