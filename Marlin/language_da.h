...
#define MSG_PREHEAT_2                       _UxGT("Forvarm PETG")
#define MSG_PREHEAT_2_N                     _UxGT("Forvarm PETG ")
#define MSG_PREHEAT_2_ALL                   _UxGT("Forvarm PETG Alle")
#define MSG_PREHEAT_2_BEDONLY               _UxGT("Forvarm PETG Bed")
#define MSG_PREHEAT_2_SETTINGS              _UxGT("Forvarm PETG conf")
