...
#define MSG_PREHEAT_2                       _UxGT("Esilämmitä PETG")
#define MSG_PREHEAT_2_N                     _UxGT("Esilämmitä PETG ")
#define MSG_PREHEAT_2_ALL                   _UxGT("Esilä. PETG Kaikki")
#define MSG_PREHEAT_2_BEDONLY               _UxGT("Esilä. PETG Alusta")
#define MSG_PREHEAT_2_SETTINGS              _UxGT("Esilämm. PETG konf")
