...
#define MSG_PREHEAT_2                       _UxGT("Pre-aquecer PETG")
#define MSG_PREHEAT_2_N                     _UxGT("Pre-aquecer PETG ")
#define MSG_PREHEAT_2_ALL                   _UxGT("Pre-aq. PETG Tudo")
#define MSG_PREHEAT_2_BEDONLY               _UxGT("Pre-aq. PETG ") LCD_STR_THERMOMETER _UxGT("Base")
#define MSG_PREHEAT_2_SETTINGS              _UxGT("Definições PETG")
