...
#define MSG_PREHEAT_2                       _UxGT("Преднагрев PETG")
...
#define MSG_UBL_BUILD_PETG_MESH              _UxGT("Построить сетку PETG")
...
#define MSG_UBL_VALIDATE_PETG_MESH           _UxGT("Проверить сетку PETG")
